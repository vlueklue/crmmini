...
function PerformanceMetrics({ reportsData }) {
    ...
    return (
        <div className="card" data-name="performance-metrics" data-file="components/PerformanceMetrics.jsx">
            <h3 className="text-lg font-semibold mb-4">Resumen de Rendimiento</h3>

            <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="text-center p-4 bg-gradient-to-r from-violet-50 to-purple-50 rounded-lg">
                    <p className="text-sm text-[var(--text-secondary)]">Satisfacción del Cliente</p>
            ...
            <div className="mb-4">
                <h4 className="font-semibold text-[var(--text-primary)] mb-3">Mejores Desempeños</h4>
                    ...
                    {topPerformers.map((performer, index) => (
                        <div key={performer.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-xs text-[var(--text-secondary)]">{performer.deals} tratos</p>
                            </div>
                        </div>
                    ))}
                </div>
