export const mockReportsData = {
  customerGrowth: [
    ...
    { month: 'Ago', customers: 267, newCustomers: 22 },
    { month: 'Sep', customers: 289, newCustomers: 22 },
    { month: 'Oct', customers: 315, newCustomers: 26 },
    { month: 'Nov', customers: 342, newCustomers: 27 },
    { month: 'Dic', customers: 368, newCustomers: 26 },
    { month: 'Ene', customers: 395, newCustomers: 27 }
  ],
  customerSegments: [
    { segment: 'Corporativo', count: 45, percentage: 35, value: 450000 },
    { segment: 'PyME', count: 78, percentage: 45, value: 285000 },
